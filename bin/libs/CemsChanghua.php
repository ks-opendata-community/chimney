...
class CemsChanghua {
    ...
    public $factories = array('N0702450', 'N1400562', 'N1504207', 'N1505633', 'N1601229', 'N3201030');
    public $items = array(
        1 => '911', //不透光率 (%)
        2 => '922', //二氧化硫 (ppm)
        3 => '923', //氮氧化物 (ppm)
    ...
    public $baseUrl = 'http://163.29.76.141/program/History/Show_Measure_Detail.asp?Date=';

    function __construct() {
        $this->rootPath = dirname(dirname(__DIR__));
        $this->tmpPath = $this->rootPath . '/tmp/changhua';
        $this->dataPath = $this->rootPath . '/data/daily/changhua';
    }
